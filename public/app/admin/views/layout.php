...
$isActive = static function (array $keys) use ($currentRoute): bool {
    foreach ($keys as $key) {
...
<nav class="adm-side" data-adm-side aria-label="Admin">
  <ul>
<?php foreach ($nav as [$href, $label, $icon, $keys]): ?>
    <li><a href="<?= e($href) ?>"<?= $isActive($keys) ? ' class="is-active" aria-current="page"' : '' ?>><svg viewBox="0 0 24 24" aria-hidden="true"><path d="<?= e($icon) ?>"/></svg><?= e($label) ?></a></li>
<?php endforeach; ?>
  </ul>
