...
<?php if ($when): ?>
    ...
    <p>We have emailed <b><?= e($booking['email']) ?></b> your confirmation, with the appointment attached so you can add it to your calendar. There is nothing to install&mdash;the video link opens in your browser.</p>
    <div class="vc-done__actions">
<?php if ($booking['meet_url']): ?>
      <a class="vc-done__join" href="<?= e($booking['meet_url']) ?>">Your video link</a>
<?php endif; ?>
      <a class="vc-done__ics" href="/virtual-consultation/booked/?ref=<?= e(rawurlencode($booking['id'])) ?>&amp;add=1">Add to my calendar</a>
    </div>
<?php if (!$booking['meet_url']): ?>
    <p class="vc-done__note">We will email you the video link before your appointment.</p>
<?php else: ?>
    <p class="vc-done__note">The same link is in your email, so you do not need to keep this page.</p>
<?php endif; ?>
