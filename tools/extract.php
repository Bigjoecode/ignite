...
const HONEYPOT = '<input type="text" name="website" value="" tabindex="-1" autocomplete="off" class="ig-hp" aria-hidden="true">';
...
$b = rep($b, '<form class="ig-form" id="igConsultForm" novalidate>',
...
$b = rep($b, '/terms-of-service/', '/terms-and-conditions/');
...
$b = rep($b, '<form class="ig-form" id="igLocForm" novalidate>',
